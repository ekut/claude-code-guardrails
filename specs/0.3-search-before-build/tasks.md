# Tasks: Search Before Build

## Task List

1. [x] Create `.claude/rules/search-before-build.md` — the main rule file with all five sections
2. [x] Update `skills/spec/SKILL.md` — change `specs/` references to `.specs/`, use version-based folder naming instead of sequential numbering, add Step 7 (commit spec before implementation)
