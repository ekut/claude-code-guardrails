# Tasks: Testing Discipline

## Task List

1. [x] Create `.claude/rules/testing-discipline.md` — rule enforcing test coverage checks, reading config or auto-discovering setup
2. [x] Create `.claude/testing.json` schema and example — document the config format; create the config for this project
3. [x] Create `skills/test-plan/SKILL.md` — skill with generate and check modes
